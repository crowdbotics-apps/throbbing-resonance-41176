...
## Project Structure
    ...
    ├── throbbing_resonance_41176  # Django project configurations
...
1. Clone this repo and `cd throbbing_resonance_41176`
...
2. Clone this repo and `cd throbbing_resonance_41176`
